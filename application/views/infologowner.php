        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                   ...
                   <div class="col-lg-12">
                    <div class="col-lg-5">
                        <img class="img-thumbnail" src="http://placehold.it/400x400" style="margin-left:100px;" alt=""><br>
                        <div class="panel panel-primary" style="margin-top:20px;">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-sm-12">
                                    <button type="button" class="btn btn-danger btn-default pull-right"data-toggle="modal" data-target="#myModal">Delete</button>
                                    <button type="button" class="btn btn-info btn-default pull-right" style="margin-right:20px;">Edit</button>
