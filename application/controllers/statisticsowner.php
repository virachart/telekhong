			...
			if ($this->session->userdata('ownerid') != null) {
				if ($this->session->userdata('storeid') != null) {
					...
					//begin part of age use qr code agian
							...
							$counttoar = 1;
							for ($i=0; $i < $count-1; $i++) { 
								array_push($data['qragage1'], $data['countqragage1d'.$counttoar]->num_rows() );
								$counttoar++;
							}
							$data['qragage2'] = array();
							$counttoar = 1;
							for ($i=0; $i < $count-1; $i++) { 
								array_push($data['qragage2'], $data['countqragage2d'.$counttoar]->num_rows() );
								$counttoar++;
							}
							$data['qragage3'] = array();
							$counttoar = 1;
							for ($i=0; $i < $count-1; $i++) { 
								array_push($data['qragage3'], $data['countqragage3d'.$counttoar]->num_rows() );
								$counttoar++;
							}
							$data['qragage4'] = array();
							$counttoar = 1;
							for ($i=0; $i < $count-1; $i++) { 
								array_push($data['qragage4'], $data['countqragage4d'.$counttoar]->num_rows() );
								$counttoar++;
							}
							$data['qragage5'] = array();
							$counttoar = 1;
							for ($i=0; $i < $count-1; $i++) { 
								array_push($data['qragage5'], $data['countqragage5d'.$counttoar]->num_rows() );
								$counttoar++;
							}
					...
					//begin part of sex use qr code agian
							...
							$counttoar = 1;
							for ($i=0; $i < $count-1; $i++) { 
								array_push($data['qragsex1'], $data['countqragsex1d'.$counttoar]->num_rows() );
								$counttoar++;
							}
							$data['qragsex2'] = array();
							$counttoar = 1;
							for ($i=0; $i < $count-1; $i++) { 
								array_push($data['qragsex2'], $data['countqragsex2d'.$counttoar]->num_rows() );
								$counttoar++;
							}
							$data['qragsex3'] = array();
							$counttoar = 1;
							for ($i=0; $i < $count-1; $i++) { 
								array_push($data['qragsex3'], $data['countqragsex3d'.$counttoar]->num_rows() );
								$counttoar++;
							}
